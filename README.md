...
## Result
The 32-bit ALU was successfully implemented using both case and if-elseif constructs.
From synthesis, the if-elseif ALU showed lower area (9913.876 µm²) and fewer cells (1242) than the case ALU.
Power analysis also showed slightly lower power for the if-elseif design.
Both designs passed functional simulation and produced correct outputs.
Thus, the if-elseif ALU performed better in area and power in our experiment.
